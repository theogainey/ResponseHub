...
type BodyDataType = 'form-data' | 'x-www-form-urlencoded' | 'file' | 'raw' | 'none';
...
const getSelectedBodyDataType = (): BodyDataType => {
  ...
  if (currentBodyType === 'form-data' || currentBodyType === 'x-www-form-urlencoded' || currentBodyType === 'file' || currentBodyType === 'raw'){
...
const requestCanHaveBody = (method: string) => method !== 'GET' && method !== 'HEAD'  && method !== 'OPTIONS';;
